...
import { GIT_HUB_PROJECT_SOURCE } from "~/lib/constants";
...
function Weather() {
  const data = useLoaderData<typeof clientLoader>() as ResponseWeatherDataI
  ...
  return (
    <Layout>
      ...
      />
      <img src="/weather/weather.png" alt="Weather" className="w-[200px] h-[200px] mb-2 object-cover"/>
      ...
      <Link to={GIT_HUB_PROJECT_SOURCE}>Source code</Link>
    </Layout>
  );
}
